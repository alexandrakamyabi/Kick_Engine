...
void Kick_Engine::GameWorld::LoadLevel(const std::filesystem::path& levelFile)
{
...
void Kick_Engine::GameWorld::DestroyGameObject(const GameObjectHandle& handle)
{
	if (!IsValid(handle))
	{
		return;
...
bool Kick_Engine::GameWorld::IsValid(const GameObjectHandle& handle)
{
...
void Kick_Engine::GameWorld::ProcessDestroyList()
{
