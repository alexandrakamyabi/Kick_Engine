...
Graphics::WaveEffect::LightData Kick_Engine::WaveLoaderComponent::GetLightData()
{
	return mLightData;
}

void WaveLoaderComponent::SetEffect(Kick_Engine::Graphics::WaveEffect* waveEffect)
{
	mEffect = waveEffect;
}
