...
namespace Kick_Engine
{
    namespace SaveUtil
    {
        void SaveVector3(const char* key, const Kick_Math::Vector3& v, rapidjson::Document& doc, rapidjson::Value& member);
        void SaveQuaternion(const char* key, const Kick_Math::Quaternion& q, rapidjson::Document& doc, rapidjson::Value& member);
