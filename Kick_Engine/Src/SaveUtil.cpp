...
void SaveUtil::SaveVector3(const char* key, const Kick_Math::Vector3& v, rapidjson::Document& doc, rapidjson::Value& member)
{
...
void SaveUtil::SaveQuaternion(const char* key, const Kick_Math::Quaternion& q, rapidjson::Document& doc, rapidjson::Value& member)
{
    rapidjson::GenericStringRef<char> str(key);
