...
void Kick_Engine::Graphics::GrassVertexShader::Initialize(const std::filesystem::path& filePath)
{
	if (mDevice == nullptr)
	{
...
void Kick_Engine::Graphics::GrassVertexShader::Terminate()
{
	SafeRelease(mVertexShader);
	SafeRelease(mInputLayout);
}

void Kick_Engine::Graphics::GrassVertexShader::Bind()
{
