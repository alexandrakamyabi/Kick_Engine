...
MeshPC Kick_Engine::Graphics::MeshBuilder::CreateRectPC(float width, float height, float depth)
{
	MeshPC mesh;
...
MeshPC Kick_Engine::Graphics::MeshBuilder::CreateHorizontalPlanePC(uint32_t numRows, uint32_t numCols, float spacing, Color color)
{
	MeshPC mesh;
...
Mesh Kick_Engine::Graphics::MeshBuilder::CreateHorizontalPlane(uint32_t numRows, uint32_t numCols, float spacing)
{
	Mesh mesh;
...
MeshD MeshBuilder::CreatePlane(uint32_t numRows, uint32_t numCols, float spacing, Kick_Engine::Color color)
{
	MeshD mesh;
...
Mesh Kick_Engine::Graphics::MeshBuilder::CreateSphere(uint32_t slices, uint32_t rings, float radius)
{
	Mesh mesh;
