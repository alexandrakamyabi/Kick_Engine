...
void GameState::Initialize()
{
	...
	mModelId = ModelManager::Get()->LoadModelId("../../Assets/Models/Animations/Sonic.model");
	//ModelManager::Get()->AddAnimation(mModelId, "../../Assets/Models/Animations/Sonic.animset");
	//ModelManager::Get()->AddAnimation(mModelId, "../../Assets/Models/Animations/Sonic.animset");
	//ModelManager::Get()->AddAnimation(mModelId, "../../Assets/Models/Animations/Sonic.animset");
